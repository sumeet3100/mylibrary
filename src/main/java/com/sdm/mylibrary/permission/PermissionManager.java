...
public class PermissionManager {
    ...
    public static void init(Context context) {
        sharedPreferences = context.getSharedPreferences("com.lucky.money", Context.MODE_PRIVATE);
    ...
    public static void askForPermission(Activity activity, String permission, PermissionCallback permissionCallback, int requestCode) {
        askForPermission(activity, new String[]{permission}, permissionCallback, requestCode);
    }

    public static void askForPermission(Activity activity, String[] permissions, PermissionCallback permissionCallback, int requestCode) {
        ...
        PermissionRequest permissionRequest = new PermissionRequest(new ArrayList<String>(Arrays.asList(permissions)), permissionCallback, requestCode);
    ...
    public static void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        if (permissionRequests.contains(requestResult)) {
            ...
            if (verifyPermissions(grantResults)) {
                ...
                permissionRequest.getPermissionCallback().permissionGranted(requestCode);
            } else {
                permissionRequest.getPermissionCallback().permissionRefused(requestCode);
