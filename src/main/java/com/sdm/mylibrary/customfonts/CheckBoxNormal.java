...
/**
 * Created by sumeetb on 10/29/2014.
 */
public class CheckBoxNormal extends CheckBox {
//    private float spacing = Spacing.NORMAL;
    private CharSequence originalText = "";
    public CheckBoxNormal(Context context) {
        super(context);
        init();
    }

    public CheckBoxNormal(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();

    }

    public CheckBoxNormal(Context context, AttributeSet attrs, int defStyle) {
