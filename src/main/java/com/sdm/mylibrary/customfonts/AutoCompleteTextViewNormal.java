 ...
 */
public class AutoCompleteTextViewNormal extends AutoCompleteTextView {
    private float spacing = Spacing.NORMAL;
    private CharSequence originalText = "";
    public AutoCompleteTextViewNormal(Context context) {
        super(context);
        init();
    }

    public AutoCompleteTextViewNormal(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public AutoCompleteTextViewNormal(Context context, AttributeSet attrs, int defStyle) {
