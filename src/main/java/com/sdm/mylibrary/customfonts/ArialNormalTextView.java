 ...
 */
public class ArialNormalTextView extends TextView {
//    private float spacing = Spacing.NORMAL;
    ...
    public ArialNormalTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ArialNormalTextView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init();
    }

    private void init() {
        Typeface tFace = Typeface.createFromAsset(getResources().getAssets(), "arial.ttf");
