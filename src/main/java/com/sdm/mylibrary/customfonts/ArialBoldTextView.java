...
//    private float spacing = Spacing.NORMAL;
    ...
    public ArialBoldTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ArialBoldTextView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init();
    }

    private void init() {
        Typeface tFace = Typeface.createFromAsset(getResources().getAssets(), "arialbd.ttf");
...
//        public final static float NORMAL = -1.1f;
//
//    }
