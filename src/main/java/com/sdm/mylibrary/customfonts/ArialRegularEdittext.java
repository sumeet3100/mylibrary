...
/**
 * Created by sumeetb on 8/18/2015.
 */
public class ArialRegularEdittext extends EditText {
    ...
    public ArialRegularEdittext(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ArialRegularEdittext(Context context, AttributeSet attrs, int defStyle) {
